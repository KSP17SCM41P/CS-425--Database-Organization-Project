...
<td><b>Product Size (in cubic ft)</b></td>
</tr>
<%
try{ 
...
<td><%=resultSet.getString("availQty") %></td>
<td><%=resultSet.getString("prodSize") %></td>
<td><a href="updateProductDetails.jsp?prodID=<%=prodID%>">UPDATE</a></td>
